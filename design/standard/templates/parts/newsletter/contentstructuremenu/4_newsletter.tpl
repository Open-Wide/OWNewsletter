        ...
        <li id="nt{$newsletter_node_id}" {if $:last_item} class="lastli"{/if}>
            ...
            <ul>
                ...
                {*def $editionObjectListDraftCount = fetch('content','list_count',
                                                                hash('parent_node_id', $newsletter_node_id,
                                                                        'extended_attribute_filter',
                                                                        hash( 'id', 'CjwNewsletterEditionFilter',
                                                                              'params', hash( 'status', 'draft' ) )
                                                                                 ) )*}
				{def $editionObjectListDraftCount = 0}
				...
				{def $editionObjectListProcessCount = 0}
				...
				{def $editionObjectListArchiveCount = 0}
				...
				{def $editionObjectListAbortCount = 0}
